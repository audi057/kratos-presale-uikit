...
var Logo$1 = function (_a) {
    ...
    return (React.createElement(Flex, null,
        ...
        isAbsoluteUrl ? (React.createElement(StyledLink$1, { as: "a", href: href, "aria-label": "Kratos Presale page" }, innerLogo)) : (React.createElement(StyledLink$1, { to: href, "aria-label": "Kratos Presale page" }, innerLogo))));
};
...
var UserBlock = function (_a) {
    ...
    return (React.createElement("div", null, account ? (React.createElement(Button, { size: "md", variant: "primary", onClick: function () {
...
var lightColors = __assign(__assign(__assign({}, baseColors), brandColors), { background: "#FAF9FA", backgroundDisabled: "#E9EAEB", contrast: "#191326", invertedContrast: "#FFFFFF", input: "#eeeaf4", tertiary: "#3a2867", text: "#e6e6ff", textDisabled: "#BDC2C4", textSubtle: "#e6e6ff", borderColor: "#E9EAEB", card: "#5c5685", gradients: {
